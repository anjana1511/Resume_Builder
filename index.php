	  ...
	  <div class="row">
          <div class="col-sm-12">
            ...
            <tr><td><span class="highlight"><?php echo $error; ?></span></td></tr>
					  <tr>
                       <td class="title-s">Enter User Name: </td> <td><input type="text" name="username" required />
                       <div class="form-group " <?php echo (!empty($username_err)) ? 'has-error' : ''; ?>">
                      </td></p>
						</tr>
						<tr>
                          <td class="title-s">Enter Password: </td> <td><input type="password" name="pass" required  />
