	...
	* @since 5.9.121 (2011-09-28)
	 ...
	 */
	 ...
	 public static function fopenLocal($filename, $mode) {
		// Check if the path is already a local file (and not a URL)
		if (strpos($filename, '://') === false) {
			// If it's a local path, no need to add 'file://'
			...
			return false;  // If it's not a local stream, return false
		}
		return fopen($filename, $mode);  // Proceed with fopen if the checks pass
	}
