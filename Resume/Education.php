							    ...
							    <table class="table record-table">
							        ...
							        <tr>
							         <td><?php echo $dis['qualification']; ?> </td>
				                        ...
				                        <td><a href="Education.php?edt=<?php echo $dis['id']; ?>"><img src="<?php echo BASE_URL; ?>assets/img/edit.png" height="30px" width="30px"></a></td>
				                        <td><a href="Education.php?del=<?php echo $dis['id']; ?>"><img src="<?php echo BASE_URL; ?>assets/img/delete.png" height="30px" width="30px"></a></td>
							            </tr>
				    				<?php	}  ?>
							   </table>
               				</div>
							    ...
							    <table class="table record-table">
							        ...
							        <tr>
							         <td><?php echo $dis['cname']; ?> </td>
				                        ...
				                        <td><a href="Education.php?edtcer=<?php echo $dis['id']; ?>"><img src="<?php echo BASE_URL; ?>assets/img/edit.png" height="30px" width="30px"></a></td>
				                        <td><a href="Education.php?delcer=<?php echo $dis['id']; ?>"><img src="<?php echo BASE_URL; ?>assets/img/delete.png" height="30px" width="30px"></a></td>
							            </tr>
				    				<?php	}  ?>
							   </table>
               				</div>
